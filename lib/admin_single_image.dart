...
class AdminSingleImage extends StatefulWidget {

  List <String> images;
  int index;

  AdminSingleImage(List <String> images,int index) {
    this.images = images;
    this.index = index;
  }

  @override
  _AdminSingleImageState createState() => _AdminSingleImageState(images,index);
}

class _AdminSingleImageState extends State<AdminSingleImage> {

  List <String> images;
  int index;
  bool imageDeleted = false;

  _AdminSingleImageState(List <String> images,int index) {
    this.images = images;
    this.index = index;
  }
