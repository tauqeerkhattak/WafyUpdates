...
class EditDataEntry extends StatelessWidget {
  ...
  EditDataEntry(QueryDocumentSnapshot doc) {
    this.doc = doc;
  }
...
class EditDataEntryBody extends StatefulWidget {
  ...
  EditDataEntryBody (QueryDocumentSnapshot doc) {
    this.doc = doc;
  }

  @override
  _EditDataEntryBodyState createState() => _EditDataEntryBodyState(doc);
}

class _EditDataEntryBodyState extends State<EditDataEntryBody> {

  QueryDocumentSnapshot doc;

  _EditDataEntryBodyState(QueryDocumentSnapshot doc) {
    this.doc = doc;
  }
  ...
  void _updateDataToFirebase (String cic,String studentName,String batch,String collegeName,String mobile,String home,String district,String orbit) {
    FirebaseFirestore.instance.collection("Data Entry").doc(cic).update({
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text("Success!"),
              content: Text('Data entry updated!'),
              actions: [
                RaisedButton(
                  child: Text("Ok"),
  ...
  getAllDataFromFirebase () {
    ...
    collegeDropdown = doc.get("College Name");
    mobileController.text = doc.get("Mobile");
    homeController.text = doc.get("Home");
    districtDropdown = doc.get("District");
    orbitDropdown = doc.get("Orbit");
  }
