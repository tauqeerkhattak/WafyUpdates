...
class AdminViewNotifications extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: AdminViewNotificationsBody(),
      ),
    );
  }
}

class AdminViewNotificationsBody extends StatefulWidget {
  @override
  _AdminViewNotificationsBodyState createState() => _AdminViewNotificationsBodyState();
}

class _AdminViewNotificationsBodyState extends State<AdminViewNotificationsBody> {
